 ...
 * project.
 */
public class RobotLedSubsystem extends TimedRobot {
    ...
    public void teleopPeriodic() {
        // solid color, green
        // m_candle.setControl(new SolidColor(kSlot0StartIdx, kSlot0EndIdx).withColor(kGreen));
