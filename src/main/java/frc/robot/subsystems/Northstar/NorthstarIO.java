...
public class NorthstarIO implements NorthstarInterface {
  ...
  public void updateInputs(VisionIOInputs inputs, AprilTagVisionIOInputs aprilTagInputs, ObjDetectVisionIOInputs objDetectInputs) {
