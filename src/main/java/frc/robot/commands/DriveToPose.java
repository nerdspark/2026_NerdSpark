...
public class DriveToPose extends Command {
  ...
  private final ProfiledPIDController driveController =
      new ProfiledPIDController(
          Constants.Vision.kPXController, Constants.Vision.kIXController, Constants.Vision.kDXController, new TrapezoidProfile.Constraints(Constants.Vision.MAX_VELOCITY,Constants.Vision.MAX_ACCELERATION), loopPeriodSecs);
